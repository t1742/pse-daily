...
- **PSE Composite Index** — index value, daily change, 60-day chart, and AI market summary
- **Stock Watchlist** — your tracked stocks with price, change, 60-day sparkline chart, and AI insight
- **Top 10 Gainers & Losers** — biggest movers of the day with AI insights
...
### 4. Get a Groq API key (for AI insights — free)

1. Sign up at [console.groq.com](https://console.groq.com)
2. Go to **API Keys → Create API key**
3. Copy the key (starts with `gsk_`)

Free tier: 14,400 requests/day — more than enough. The newsletter still works without this key, it just skips the insight text.
...
| `GROQ_API_KEY` | Groq API key from step 4 (starts with `gsk_`) |
...
To include AI insights in the preview, set your Groq key first:
...
**Charts are embedded** directly in the email as inline attachments (CID), so they display correctly in Gmail without being blocked.
